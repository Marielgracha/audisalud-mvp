...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "Arial, sans-serif" }}>
      ...
      {/* Sidebar */}
      <div style={{ width: 210, background: "#1A1A18", flexShrink: 0 }}>
          ...
          {menu.map(m => (
            <button key={m.id} onClick={() => setTab(m.id)}
              style={{
                ...
                background: tab === m.id ? "rgba(201,168,76,.25)" : "transparent",
                color: tab === m.id ? "#C9A84C" : "rgba(255,255,255,.7)",
        ...
        <div style={{ padding: "12px 10px", marginTop: "auto", borderTop: "1px solid rgba(255,255,255,.1)" }}>
